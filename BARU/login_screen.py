...
class Login(QWidget):
    ...
    def __init__(self):
        ...
        self.setMinimumSize(int(initial_width * 0.7), int(initial_height * 0.7)) 
        ...
        container_layout.setSpacing(int(initial_height * 0.05))
        container_layout.setContentsMargins(0,0,0,0)
        container.setLayout(container_layout)
        container.setSizePolicy(QSizePolicy.Expanding, QSizePolicy.Fixed)

        self.title_widget = ShadowedTitle("Physim", parent=container) 
        ...
        layout.setSpacing(int(initial_height * 0.02))
    ...
    def login_resizeEvent(self, event):
        ...
        logo_icon = self.findChild(QLabel) 
        if logo_icon:
